...
public class AdapterHome extends BaseAdapter {
    ...
    public AdapterHome(Context c,/* ArrayList<HashMap<String,String>> arr_order,*/  ArrayList<String> order_id) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view1 == null) {
            ...
            view1 = inflater.inflate(R.layout.home_single_row, null, true);

            tv_comment = (TextView)view1.findViewById(R.id.tv_comment);
            tv_comment.setText(order_id.get(position)+" Comments");
